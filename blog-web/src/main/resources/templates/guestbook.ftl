            ...
            <div class="blog-body expansion">
                <div class="alert alert-default alert-dismissible" role="alert" style="padding: 0px;">
                    <ul>
                        ...
                        <li><i class="fa fa-lightbulb-o fa-fw"></i> 欢迎各种花式留言！e.g.<code>System.out.println("我要把冠军一顿爆当!当的锃光瓦亮!");</code></li>
                        <li><i class="fa fa-heartbeat fa-fw"></i> <strong>沙河，沙河，走了，走了...</strong></li>
                    </ul>
                </div>
            </div>
        </div>
